                ...
                <Container className='footer'>
                    ...
                    <div>
                       ...
                       <a style={{textDecoration: "none", color:"white"}}target="_blank" rel="noopener noreferrer"href="https://discord.com/"> <BsDiscord size={32} />   </a>      */}
                        ...
                        <p><a target="_blank" rel="noopener noreferrer" href="https://metaversesolutions.ai" style={{ textDecoration: "none", color: "darkcyan", textAlign: "right" }}><text className="metaverse">Metaverse Solutions, LLC</text></a></p>
